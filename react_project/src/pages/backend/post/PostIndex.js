...
const PostIndex = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const result2 = await TopicService.index(); // Fetch topics separately
                setPosts(result.posts);
                setTopics(result2.topics);
                setLoad(true);
            } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        post.append("topic_id", selectedTopic); // Include selected topic in the form data
                                            ...
                                            <div className="row mt-3 align-items-center">
                                                <div className="col-12">
                                                    <button type="button" class="btn btn-info">
                                                        <a href="/admin/post/trash">Thùng rác</a>
                                                    </button>
                                                </div>
                                            </div>
                                                                ...
                                                                <tr className="datarow" key={index}>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div className="function_style">
                                                                            <button>
                                                                                <a href={`/admin/post/edit/${post.id}`} className="px-1 text-success">
                                                                                    <FaEdit />
                                                                                </a>
                                                                            </button>
                                                                            <button
